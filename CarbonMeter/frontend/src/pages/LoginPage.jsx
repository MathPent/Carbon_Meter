            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="relative mb-2">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-dark-green pr-12"
                  required
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-dark-green focus:outline-none"
